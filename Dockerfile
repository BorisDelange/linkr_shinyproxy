...
RUN R -e "install.packages(c('shiny', 'rmarkdown', 'clipr', 'curl', 'DBI', 'dplyr', 'DT', 'ggplot2', 'golem', 'glue', 'knitr', 'magrittr', 'pkgload', 'plotly', 'pryr', 'readr', 'rlang', 'rlist', 'RPostgres', 'RSQLite', 'shiny.fluent', 'shiny.i18n', 'shinymanager', 'shiny.react', 'shiny.router', 'shinyAce', 'shinybusy', 'shinyjs', 'sortable', 'stringr', 'tidyr', 'XML', 'zip'), repos='https://cloud.r-project.org/')"
...
CMD ["R", "-e", "linkr::link(language = 'fr')"]