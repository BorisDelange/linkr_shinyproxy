...
# After running this function, data is accessible with r$... variables (eg d$patients for patients)
...
# We can add some filters here (eg d$patients %>% dplyr::filter(age > 18) to get patients with an age superior to 18 y-old)
