...
<br />
Enter a name, choose the module family, **choose the module you've just created**, choose the **Dygraph plugin**.
Now, choose the thesaurus : a datatable appears, with the **items of the thesaurus**.
If you choose **our test datamart**, you can choose to display only the items used in your datamart.
Now, choose the colours of your items and add them : here we add *Heart rate* & *Systolic blood pressure*.
