...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/BorisDelange/cdwtools/blob/master/inst/app/www/mimic_iv_tutorial/EN_create_data_source.png?raw=true")
```
...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/BorisDelange/cdwtools/blob/master/inst/app/www/mimic_iv_tutorial/EN_import_datamart.png?raw=true")
```
...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/BorisDelange/cdwtools/blob/master/inst/app/www/mimic_iv_tutorial/EN_thesaurus_items.png?raw=true")
```
...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/BorisDelange/cdwtools/blob/master/inst/app/www/mimic_iv_tutorial/EN_thesaurus_items_module_element.png?raw=true")
```
...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/BorisDelange/cdwtools/blob/master/inst/app/www/mimic_iv_tutorial/EN_patient_lvl_data.png?raw=true")
```

Try to change patient, stay...
