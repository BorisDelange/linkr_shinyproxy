...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/BorisDelange/cdwtools/blob/master/inst/app/www/mimic_iv_tutorial/EN_thesaurus_items_datatable.png?raw=true")
```
...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/BorisDelange/cdwtools/blob/master/inst/app/www/mimic_iv_tutorial/EN_thesaurus_items_module_element_datatable.png?raw=true")
```
