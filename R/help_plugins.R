  ...
  observeEvent(r[[paste0("help_plugins_", prefix, "_page_5")]], {
    ...
    if (language == "en"){
      r[[paste0("help_plugins_", prefix, "_modal_text")]] <- div(
        ...
        p("Name and category displayed in the ", tags$em("All plugins"), " tab, depending on the language chosen at application startup."),
        ...
        p("This image can then be chosen in the dropdown menu to be ", strong("the image presenting the plugin"), " in the ", tags$em("All plugins"), " tab."),
