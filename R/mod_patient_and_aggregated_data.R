    ...
    observeEvent(input$help_1, {
      ...
      if (language == "FR"){
        ...
        r[[paste0(prefix, "_help_modal_text")]] <- div(
          ...
          p("Il est possible de créer d'autres subsets, dans l'onglet 'Mes subsets' en haut de l'écran."),
          patient_lvl_help_1_text
        )
      }
      ...
      if (language == "FR"){
        ...
        r[[paste0(prefix, "_help_modal_text")]] <- div(
          ...
          tags$ul(
            ...
            tags$li(strong("amount"), " : Quantité du médicament / de l'administration non médicamenteuse (numeric)"),
            tags$li(strong("amount_unit"), " : Unité de la quantité (character)"),
            tags$li(strong("rate"), " : Débit du médicament / de l'administration non médicamenteuse (numeric)"),
