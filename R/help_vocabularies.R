  ...
  observeEvent(r$help_vocabularies_page_4, {
    ...
    if (language == "fr"){
      r$help_vocabularies_modal_text <- div(
        r$help_vocabularies_modal_text <- div(
          ...
          p("Par exemple, la requête ", tags$a(href = "https://athena.ohdsi.org/search-terms/terms?vocabulary=LOINC&page=1&pageSize=15&query=heart+rate", "heart rate in Athena", target = "_blank"), 
          ...
          p("Dans LinkR, en sélectionnant la terminologie LOINC, en cherchant 'heart rate' et en triant par le nombre de lignes ou de jeux de données, j'obtiens le ", strong("concept adéquat"), " en première position."),
    ...
    if (language == "en"){
      r$help_vocabularies_modal_text <- div(
        ...
        p("In LinkR, by selecting the LOINC terminology, searching for 'heart rate' and sorting by the number of rows or data sets, I obtain the ", strong("suitable concept"), " in the first position."),
