...
#     
#     people_picker <- div(
#       div(class = "input_title", paste0(i18n$t(paste0(get_singular(id), "_users_allowed_read"), words), " :")),
...
#         make_people_picker(
#           i18n = i18n, ns = ns, id = "users_allowed_read", label = "users",
...
#         make_toggle(i18n = i18n, ns = ns, label = "show_only_aggregated_data", value = value, inline = TRUE)
#       )
#     )
#   }
# 
