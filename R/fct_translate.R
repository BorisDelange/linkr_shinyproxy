...
get_translations <- function(){
  ...
  # if (!file.exists(needed_file)){
    dplyr::tribble(~language, ~reference_word, ~translated_word,
            ...
            "EN", "users_statuses_added", "New status added",
            "FR", "users_statuses_added", "Nouveau statut ajouté",
            "EN", "users_accesses_added", "New access added",
            "FR", "users_accesses_added", "Nouvel accès ajouté",
