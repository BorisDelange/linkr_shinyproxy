...
get_translations <- function(){
    ...
    "FR", "patient_lvl_module_element_added", "Encart ajouté",
    ...
    "FR", "aggregated_module_element_added", "Encart ajouté",
    "EN", "group", "Group",
    "FR", "group", "Groupe",
    "EN", "study", "Study",
    "FR", "study", "Etude",
    ...
    "FR", "modules_elements_creation_card", "Nouvel encart",
    ...
    "FR", "modules_elements_management_card", "Gestion encarts",
    ...
    "FR", "new_module_element", "Encart",
    "EN", "add_module_element", "Add a module element",
    "FR", "add_module_element", "Nouvel encart",
    "EN", "figure", "Figure",
    "FR", "figure", "Figure",
    ...
    "FR", "aggregated_modules_elements_group_delete", "Supprimer un encart",
    "EN", "aggregated_modules_elements_group_delete_subtext", "Do you want to delete this module element ?",
    "FR", "aggregated_modules_elements_group_delete_subtext", "Confirmer la suppression de cet encart ?",
    "EN"," group_id", "Group ID",
    "FR", "group_id", "Group ID",
    "EN", "patient_lvl_modules_elements_group_delete", "Delete a module element",
    "FR", "patient_lvl_modules_elements_group_delete", "Supprimer un encart",
    "EN", "patient_lvl_modules_elements_group_delete_subtext", "Do you want to delete this module element ?",
    "FR", "patient_lvl_modules_elements_group_delete_subtext", "Confirmer la suppression de cet encart ?",
    ...
    "FR", "patient_lvl_module_element_group_deleted", "Encart supprimé",
    "EN", "aggregated_module_element_group_deleted", "Module element deleted",
    "FR", "aggregated_module_element_group_deleted", "Encart supprimé",
    "EN", "aggregated_modules_elements_delete", "Delete a module family element",
    "FR", "aggregated_modules_elements_delete", "Supprimer un encart",
    "EN", "aggregated_modules_elements_delete_subtext", "Do you want to delete this module element ?",
    "FR", "aggregated_modules_elements_delete_subtext", "Confirmer la suppression de cet encart ?",
    "EN", "aggregated_module_element_deleted", "Module element deleted",
    "FR", "aggregated_module_element_deleted", "Encart supprimé",
    ...
    "FR", "modules_elements_management", "Gestion des encarts",
    ...
    "FR", "module_element_added", "Encart ajouté",
    "EN", "module_element_deleted", "Module element deleted",
    "FR", "module_element_deleted", "Encart supprimé",
    ...
    "FR", "change_display_order_module_element", "Changer l'ordre d'affichage des encarts",
    "EN", "module_element", "Module element",
    "FR", "module_element", "Nom de l'encart",
    ...
    "FR", "no_module_element_to_show", "Pas d'encart à afficher",
    ...
    "FR", "empty_page", "Ce module ne contient aucun encart",
    ...
    "FR", "add_module_has_modules_elements", "Impossible d'ajouter un module en-dessous de celui-ci parce qu'il contient au moins un encart. Supprimer les encarts avant.",
