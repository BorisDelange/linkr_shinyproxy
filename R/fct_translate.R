...
get_translations <- function(){
  ...
  # if (!file.exists(needed_file)){
    dplyr::tribble(~language, ~reference_word, ~translated_word,
            ...
            "EN", "accesses_creation_card", "Add access",
            "FR", "accesses_creation_card", "Ajouter accès",
            ...
            "FR", "accesses_management", "Gestion des accès",
            "EN", "accesses_options_card", "Accesses opts",
            "FR", "accesses_options_card", "Options accès",
            "EN", "accesses_options", "Accesses management",
            "FR", "accesses_options", "Gestion des accès",
            "EN", "statuses_creation_card", "Add status",
            "FR", "statuses_creation_card", "Ajouter statut",
