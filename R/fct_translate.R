...
get_translations <- function(){
  ...
  # if (!file.exists(needed_file)){
    dplyr::tribble(~language, ~reference_word, ~translated_word,
            ...
            "EN", "import_datamart_success_patients", "Datamart patients imported with success",
            "FR", "import_datamart_success_patients", "Datamart patients importé avec succès",
            "EN", "import_datamart_success_stays", "Datamart stays imported with success",
            "FR", "import_datamart_success_stays", "Datamart stays importé avec succès",
            "EN", "import_datamart_success_labs_vitals", "Datamart labs_vitals imported with success",
            "FR", "import_datamart_success_labs_vitals", "Datamart labs_vitals importé avec succès",
            "EN", "import_datamart_success_text", "Datamart text imported with success",
            "FR", "import_datamart_success_text", "Datamart text importé avec succès",
            "EN", "import_datamart_success_orders", "Datamart orders imported with success",
            "FR", "import_datamart_success_orders", "Datamart orders importé avec succès",
