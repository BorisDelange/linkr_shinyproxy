...
get_translations <- function(){
    ...
    "FR", "patient_lvl_module_element_added", "Elément de module ajouté",
    ...
    "FR", "aggregated_module_element_added", "Elément de module ajouté",
    "EN", "group", "Group",
    "FR", "group", "Groupe",
    "EN", "study", "Study",
    "FR", "study", "Etude",
    ...
    "FR", "modules_delete_subtext", "Confirmer la suppression de ce module ?",
    ...
    "FR", "modules_elements_creation_card", "Nouvel élément de module",
    "EN", "patient_lvl_modules_creation_card", "Create a new module",
    "FR", "patient_lvl_modules_creation_card", "Créer un nouveau module",
    ...
    "FR", "modules_elements_management_card", "Gestion éléments de module",
    ...
    "FR", "new_module_element", "Elément de module",
    "EN", "add_module_element", "Add a module element",
    "FR", "add_module_element", "Nouvel élément de module",
    "EN", "figure", "Figure",
    "FR", "figure", "Figure",
    ...
    "FR", "patient_lvl_modules", "Modules données individuelles",
    ...
    "FR", "patient_lvl_modules_delete_subtext", "Confirmer la suppression du module ?",
    "EN", "patient_lvl_module_deleted", "Module deleted",
    "FR", "patient_lvl_module_deleted", "Module supprimé",
    "EN", "aggregated_modules", "Aggregated modules",
    "FR", "aggregated_modules", "Modules données agrégées",
    ...
    "FR", "aggregated_modules_delete_subtext", "Confirmer la suppression du module ?",
    ...
    "EN", "aggregated_modules_elements_group_delete", "Delete a module element",
    "FR", "aggregated_modules_elements_group_delete", "Supprimer un élément de module",
    "EN", "aggregated_modules_elements_group_delete_subtext", "Do you want to delete this module element ?",
    "FR", "aggregated_modules_elements_group_delete_subtext", "Confirmer la suppression de cet élément de module ?",
    "EN"," group_id", "Group ID",
    "FR", "group_id", "Group ID",
    "EN", "patient_lvl_modules_elements_group_delete", "Delete a module element",
    "FR", "patient_lvl_modules_elements_group_delete", "Supprimer un élément de module",
    "EN", "patient_lvl_modules_elements_group_delete_subtext", "Do you want to delete this module element ?",
    "FR", "patient_lvl_modules_elements_group_delete_subtext", "Confirmer la suppression de cet élément de module ?",
    ...
    "FR", "patient_lvl_module_element_group_deleted", "Elément de module supprimé",
    "EN", "aggregated_module_element_group_deleted", "Module element deleted",
    "FR", "aggregated_module_element_group_deleted", "Elément de module supprimé",
    "EN", "aggregated_modules_elements_delete", "Delete a module family element",
    "FR", "aggregated_modules_elements_delete", "Supprimer un élément de module",
    "EN", "aggregated_modules_elements_delete_subtext", "Do you want to delete this module element ?",
    "FR", "aggregated_modules_elements_delete_subtext", "Confirmer la suppression de cet élément de module ?",
    "EN", "aggregated_module_element_deleted", "Module element deleted",
    "FR", "aggregated_module_element_deleted", "Elément de module supprimé",
    ...
    "EN", "modules_elements_management", "Modules elements management",
    "FR", "modules_elements_management", "Gestion des éléments de module",
    ...
    "FR", "module_element_added", "Elément de module ajouté",
    "EN", "module_element_deleted", "Module element deleted",
    "FR", "module_element_deleted", "Elément de module supprimé",
    ...
    "EN", "delete_module_element", "Delete a module element",
    "FR", "delete_module_element", "Supprimer un élément de module",
    "EN", "change_display_order_module_element", "Change display order of of module elements",
    "FR", "change_display_order_module_element", "Changer l'ordre d'affichage des éléments de module",
    "EN", "module_element", "Module element",
    "FR", "module_element", "Nom de l'élément de module",
    ...
    "FR", "no_module_element_to_show", "Pas d'élément de module à afficher",
    ...
    "FR", "empty_page", "Ce module ne contient aucun élément de module",
    ...
    "FR", "add_module_has_modules_elements", "Impossible d'ajouter un module en-dessous de celui-ci parce qu'il contient au moins un élément de module. Supprimer les éléments de module avant.",
