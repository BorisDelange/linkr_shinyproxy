...
The core principle of the App is the **modularity** : each user chooses which pages to display (called **modules** in the app, Haemodynamics or Respiratory modules in the above screenshot), which **figures** display in each page (a timeline ? a text area ?), which **thesaurus items** each figure uses.
