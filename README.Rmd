...
<br />
The application contains a **data management section**, that allows the import of datamarts & thesaurus, the creation of studies & subsets. You choose who has access to which part of the app in the **users management section**.
