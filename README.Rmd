...
- *app_folder*: by default, application files are saved in the current R session folder (`getwd()` to know which folder it is). You can change this folder by specifying the target folder in this argument.
